...
namespace Sportwagens_GUI
{
    class Sportwagen : Wagen
    {
        ...
        public Sportwagen(Merken merk, Types type, int kmTeller, DateTime inGebruikDatum, string nummerplaat, double pk, int aantalVitessen) : base(merk, type, kmTeller, inGebruikDatum, nummerplaat)
        {
            this.PK = pk;
        ...
        {
            return "Sportwagen: " + base.ToString() + " PK: " + this.PK + " AantalVitessen: " + this.AantalVitessen;
        }
    }
}
